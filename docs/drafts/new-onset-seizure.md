...
- Added ICU column to Section 4C (Lifestyle & Prevention) for format consistency per S2
- All 4 settings (ED, HOSP, OPD, ICU) now represented in all Section 4 tables

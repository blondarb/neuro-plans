...
|------|-----------|----------------|:--:|:----:|:---:|:---:|
| TSH (CPT 84443) | Hyperthyroidism is a common reversible cause of enhanced physiologic tremor; hypothyroidism rarely causes tremor | Normal (0.4-4.0 mIU/L); abnormal TSH → free T4; hyperthyroidism → treat underlying cause, tremor resolves | ROUTINE | ROUTINE | ROUTINE | - |
| Free T4 (CPT 84439) | If TSH abnormal; confirms hyper- or hypothyroidism as cause of tremor | Normal; elevated → hyperthyroidism contributing to tremor | ROUTINE | ROUTINE | ROUTINE | - |
| CMP (CPT 80053) | Electrolyte derangements (hypoglycemia, hyponatremia, uremia, hepatic dysfunction) can cause or worsen tremor | Normal; hypoglycemia, hyponatremia, liver failure, renal failure can all produce tremor | URGENT | ROUTINE | ROUTINE | - |
| Glucose (CPT 82947) | Hypoglycemia is an acute reversible cause of tremor; hyperglycemia with diabetic neuropathy | Normal (70-100 mg/dL fasting); hypoglycemia → treat and tremor resolves | URGENT | ROUTINE | ROUTINE | - |
| CBC with differential (CPT 85025) | General health assessment; infection screen; anemia workup | Normal; leukocytosis may suggest infectious or inflammatory cause | ROUTINE | ROUTINE | ROUTINE | - |
| Comprehensive medication reconciliation | Drug-induced tremor is one of the most common causes; must review ALL current medications including OTC, herbal, and supplements | Complete medication list; identify tremor-inducing agents (valproate, lithium, SSRIs, stimulants, bronchodilators, amiodarone, metoclopramide, antipsychotics) | STAT | STAT | ROUTINE | - |
| Caffeine intake assessment | Excessive caffeine is a leading cause of enhanced physiologic tremor; often overlooked | Quantify daily caffeine intake (coffee, tea, energy drinks, supplements); >400 mg/day may cause significant tremor | ROUTINE | ROUTINE | ROUTINE | - |

### 1B. Extended Workup (Second-line)

| Test | Rationale | Target Finding | ED | HOSP | OPD | ICU |
|------|-----------|----------------|:--:|:----:|:---:|:---:|
| Serum ceruloplasmin (CPT 82390) | Wilson disease screening in patients <50 years or with atypical features (hepatic dysfunction, psychiatric symptoms, Kayser-Fleischer rings) | 20-40 mg/dL; low (<20 mg/dL) → 24-hour urine copper, slit-lamp exam for K-F rings | - | ROUTINE | ROUTINE | - |
| 24-hour urine copper (CPT 82525) | Wilson disease confirmation if ceruloplasmin low or borderline | <40 mcg/24h normal; >100 mcg/24h strongly suggestive of Wilson disease | - | EXT | EXT | - |
| Serum copper (CPT 82390) | Wilson disease evaluation alongside ceruloplasmin; copper deficiency can also cause neurological symptoms | Normal (70-140 mcg/dL); low total copper with low ceruloplasmin → Wilson disease | - | ROUTINE | ROUTINE | - |
| Liver function tests (CPT 80076) | Wilson disease screening; hepatic encephalopathy; medication hepatotoxicity | Normal; abnormal → evaluate for Wilson disease, hepatic tremor | - | ROUTINE | ROUTINE | - |
| Vitamin B12 (CPT 82607) | Deficiency can cause tremor, neuropathy, and myelopathy contributing to movement disorder | >400 pg/mL; borderline (200-400) → methylmalonic acid; deficiency → supplement | - | ROUTINE | ROUTINE | - |
| Drug levels (lithium, valproate, phenytoin, theophylline) (CPT 80178/80164/80185/80198) | Drug toxicity is a common and reversible cause of tremor; supratherapeutic levels worsen EPS | Therapeutic ranges; supratherapeutic → dose adjustment or discontinuation | URGENT | ROUTINE | ROUTINE | - |
| Drug/toxin screen (CPT 80307) | Identify sympathomimetics, illicit substances (amphetamines, cocaine), or other toxins causing tremor | Negative; positive → identify offending agent and address | URGENT | ROUTINE | ROUTINE | - |
| Urine metanephrines/catecholamines | Pheochromocytoma presenting with tremor, hypertension, tachycardia, and diaphoresis | Normal; elevated → CT/MRI adrenals, endocrinology referral | - | EXT | EXT | - |
| Magnesium (CPT 83735) | Hypomagnesemia contributes to tremor and neuromuscular excitability; common in alcoholism | Normal (1.7-2.2 mg/dL); low → supplement | URGENT | ROUTINE | ROUTINE | - |
| ESR (CPT 85652) / CRP (CPT 86140) | Inflammatory markers if autoimmune or paraneoplastic etiology suspected | Normal; elevated → further workup for inflammatory/autoimmune cause | - | ROUTINE | ROUTINE | - |

### 1C. Rare/Specialized

| Test | Rationale | Target Finding | ED | HOSP | OPD | ICU |
|------|-----------|----------------|:--:|:----:|:---:|:---:|
| Heavy metal levels (mercury, lead, manganese, arsenic) | Occupational or environmental exposure causing tremor; manganese causes parkinsonism | Normal; elevated → toxicology consultation, chelation therapy | - | - | EXT | - |
| Anti-neuronal antibodies (paraneoplastic panel) (CPT 86255) | Autoimmune or paraneoplastic movement disorder presenting as tremor | Negative; positive → malignancy search and immunotherapy consideration | - | - | EXT | - |
| Anti-GAD65 antibodies (CPT 86235) | Autoimmune movement disorder (stiff-person spectrum, cerebellar ataxia with tremor) | Negative; positive at high titers → autoimmune etiology | - | - | EXT | - |
| Genetic testing (LINGO1, FUS, ETM1/2, DYT genes) | Family history of tremor or dystonia; research interest; young-onset tremor | Informational; positive → genetic counseling | - | - | EXT | - |
| Serum ferritin and iron studies | Restless legs/periodic limb movements sometimes confused with tremor; iron deposition disorders | Normal; low ferritin (<50 mcg/L) → supplement; very high ferritin → iron overload evaluation | - | - | EXT | - |
| Cortisol level (CPT 82533) | Cushing syndrome with tremor and proximal myopathy | Normal; elevated → dexamethasone suppression test | - | - | EXT | - |
...
|-------|--------|----------------|-------------------|:--:|:----:|:---:|:---:|
| Comprehensive neurologic examination | At presentation; document tremor type, distribution, activation conditions, frequency, associated signs (bradykinesia, rigidity, dystonia, ataxia) | Characterize tremor (rest, postural, kinetic, intention, task-specific); identify associated neurologic signs; laterality and symmetry | None | STAT | ROUTINE | ROUTINE | - |
| Handwriting sample | At presentation and follow-up visits; compare over time | Large, tremulous writing (essential tremor) vs micrographia (Parkinson's); progressive change | None | - | ROUTINE | ROUTINE | - |
| Spiral drawing test (Archimedes spiral) | At presentation; objective assessment tool | Objective tremor severity rating; track progression or treatment response | None | - | ROUTINE | ROUTINE | - |
| Finger-to-nose testing | At presentation | Dysmetria and intention tremor → cerebellar cause; past-pointing increases with action → intention tremor | None | ROUTINE | ROUTINE | ROUTINE | - |
| CT head without contrast (CPT 70450) | STAT if acute onset tremor with other neurologic signs (weakness, ataxia, altered consciousness) suggesting structural lesion | Rule out hemorrhage, mass, hydrocephalus; does NOT adequately visualize posterior fossa or midbrain | None for non-contrast | STAT | STAT | - | - |

### 2B. Extended

| Study | Timing | Target Finding | Contraindications | ED | HOSP | OPD | ICU |
|-------|--------|----------------|-------------------|:--:|:----:|:---:|:---:|
| MRI brain without contrast (CPT 70551) | If structural cause suspected; atypical features; young onset; acute onset | Rule out midbrain/thalamic lesion (Holmes tremor), cerebellar lesion, basal ganglia pathology, Wilson disease (T2 basal ganglia changes), demyelination | MRI-incompatible implants, severe claustrophobia | - | ROUTINE | ROUTINE | - |
| MRI brain with and without contrast (CPT 70553) | If mass lesion, demyelination, or infection suspected | Midbrain lesion (Holmes tremor); cerebellar tumor/abscess; MS plaques; basal ganglia enhancement | MRI-incompatible implants; contrast allergy; GFR <30 for gadolinium | - | ROUTINE | ROUTINE | - |
| DaTscan (Ioflupane I-123 SPECT) (CPT 78830) | Key study to differentiate essential tremor from Parkinson's disease when clinical features overlap; order when diagnostic uncertainty persists after clinical evaluation | Normal striatal uptake → essential tremor, enhanced physiologic tremor, drug-induced tremor, psychogenic tremor; reduced striatal uptake → Parkinson's disease, MSA, PSP, DLB | Pregnancy; iodine/shellfish allergy; hold interfering medications (bupropion, amphetamines, modafinil, cocaine) 2 weeks before | - | - | ROUTINE | - |
| MRI with susceptibility-weighted imaging (SWI) | If Wilson disease or iron deposition suspected | Basal ganglia T2 hypointensity (iron deposition); "face of the giant panda" sign in Wilson disease (midbrain) | Per MRI contraindications | - | ROUTINE | ROUTINE | - |
| Accelerometry / Tremor analysis | Objective quantification of tremor frequency and amplitude; distinguish tremor types by frequency characteristics | ET: 4-12 Hz; physiologic: 8-12 Hz; PD rest: 4-6 Hz; cerebellar: 3-5 Hz; Holmes: <4.5 Hz; orthostatic: 13-18 Hz | None | - | - | EXT | - |
| EMG (CPT 95885) | If neuropathic tremor suspected; orthostatic tremor evaluation; distinguish tremor types | Rhythmic bursting pattern; high-frequency EMG bursts in orthostatic tremor (13-18 Hz); neuropathic tremor pattern | None significant | - | - | EXT | - |
| NCS/EMG (CPT 95907-95913) | If peripheral neuropathy suspected as contributing factor to sensory-mediated tremor | Sensory or sensorimotor neuropathy; demyelinating features (CIDP) | Anticoagulation (relative for EMG) | - | ROUTINE | ROUTINE | - |

### 2C. Rare/Specialized

| Study | Timing | Target Finding | Contraindications | ED | HOSP | OPD | ICU |
|-------|--------|----------------|-------------------|:--:|:----:|:---:|:---:|
| FDG-PET brain (CPT 78608) | Atypical parkinsonism suspected; distinguish PD from MSA, PSP, CBD | Characteristic metabolic patterns differ by diagnosis; hypometabolism in posterior cortex (DLB), frontal (PSP), asymmetric cortical (CBD) | Significant hyperglycemia; pregnancy | - | - | EXT | - |
| MIBG cardiac scintigraphy | Differentiate PD (reduced cardiac sympathetic innervation) from MSA or drug-induced parkinsonism (normal) | Reduced uptake → PD or DLB; normal → MSA, DIP, essential tremor | Drugs affecting cardiac norepinephrine uptake | - | - | EXT | - |
| Olfactory testing (UPSIT) | Supportive test; olfactory dysfunction suggests underlying PD (present early) vs normal olfaction in ET or DIP | Impaired → PD, DLB; normal → ET, DIP, functional tremor | Nasal obstruction | - | - | ROUTINE | - |
| Transcranial sonography | Substantia nigra hyperechogenicity assessment; supports PD diagnosis | Hyperechogenicity → suggests PD; normal → ET, DIP | Inadequate temporal bone window | - | - | EXT | - |
| Polysomnography (CPT 95810) | REM sleep behavior disorder suggests underlying synucleinopathy (PD, DLB, MSA) | RBD present → strongly supports underlying neurodegenerative parkinsonism | None | - | - | EXT | - |
| Slit-lamp ophthalmologic exam | Kayser-Fleischer ring detection for Wilson disease in patients <50 with low ceruloplasmin or liver disease | K-F rings present → Wilson disease highly likely | None | - | ROUTINE | ROUTINE | - |
...
|-----------|-------|------------|--------|-------------------|------------|:--:|:----:|:---:|:---:|
| Discontinue or reduce suspected causative medication | - | Drug-induced tremor; temporal relationship between medication initiation and tremor onset | - :: - :: - :: Identify and discontinue offending agent if safe; taper if abrupt withdrawal is dangerous (benzodiazepines, antiepileptics, antipsychotics); coordinate with prescribing physician | Active psychosis, seizure disorder, or condition requiring the medication without safe alternative | Symptom resolution timeline; withdrawal symptoms; rebound of treated condition | STAT | STAT | ROUTINE | - |
| Correct underlying metabolic derangement | IV/PO | Enhanced physiologic tremor from metabolic cause (hypoglycemia, hyponatremia, hypomagnesemia, hyperthyroidism) | - :: IV/PO :: - :: Treat underlying cause: dextrose for hypoglycemia; correct electrolytes per standard protocols; thyroid suppression for hyperthyroidism | Per specific treatment | Metabolic panel; tremor resolution with correction | STAT | STAT | ROUTINE | - |
| Propranolol (empiric) | PO | Empiric symptomatic relief for functionally impairing tremor while diagnostic workup in progress; effective for postural and action tremor | 20 mg :: PO :: BID :: Start 20 mg BID; titrate by 20 mg q3-7d based on response and tolerability; target 60-320 mg/day in divided doses; may use LA formulation once optimal dose determined | Asthma/severe COPD; bradycardia (HR <50); second/third-degree AV block; decompensated heart failure; severe peripheral vascular disease; concurrent verapamil | HR, BP at each visit; bronchospasm; fatigue, depression; masks hypoglycemia in diabetics | - | ROUTINE | ROUTINE | - |
...
| Primidone (Mysoline) | PO | Alternative first-line for action/postural tremor; particularly if propranolol contraindicated or inadequate | 12.5 mg :: PO :: QHS :: Start 12.5-25 mg QHS (ultra-low dose); titrate very slowly by 12.5-25 mg/week; target 250-750 mg/day in divided doses; initiation reaction (nausea, dizziness, sedation) common — start very low | Porphyria; severe sedation to initial dose; pregnancy (teratogenic) | Sedation, ataxia, nausea (especially first dose — warn patient); CBC periodically; cognitive effects in elderly | - | ROUTINE | ROUTINE | - |
...
| Methimazole or propylthiouracil | PO | Hyperthyroid tremor; treat the underlying thyroid disease | - :: PO :: - :: Per endocrinology dosing for hyperthyroidism; tremor resolves with euthyroid state | Per antithyroid drug contraindications; PTU: hepatotoxicity; methimazole: pregnancy first trimester | Thyroid function tests q4-8 weeks initially; CBC (agranulocytosis risk); LFTs (PTU) | - | ROUTINE | ROUTINE | - |
| D-Penicillamine or trientine | PO | Wilson disease confirmed; copper chelation | - :: PO :: - :: D-penicillamine 250 mg daily, increase by 250 mg q4-7d to 1000-1500 mg/day divided QID; OR trientine 250 mg TID, titrate to 750-1500 mg/day divided TID | D-penicillamine: penicillin allergy (relative), renal impairment, blood dyscrasias; trientine: iron supplementation (separate by 2 hours) | 24-hour urine copper, CBC, urinalysis q1-2 months initially; hepatologist co-management | - | ROUTINE | ROUTINE | - |
| Amantadine | PO | If parkinsonian features suspected but not yet confirmed; mild symptomatic benefit; avoids levodopa commitment | 100 mg :: PO :: daily :: Start 100 mg daily; may increase to 100 mg BID after 1 week; max 300 mg/day; reduce dose if CrCl <50 | Severe renal impairment (CrCl <15); seizure history (relative); livedo reticularis | Renal function; hallucinations (especially elderly); insomnia (avoid evening dosing); livedo reticularis; ankle edema | - | ROUTINE | ROUTINE | - |

### 3D. Non-Pharmacologic Treatments

| Treatment | Route | Indication | Dosing | Contraindications | Monitoring | ED | HOSP | OPD | ICU |
|-----------|-------|------------|--------|-------------------|------------|:--:|:----:|:---:|:---:|
| Caffeine reduction or elimination | Dietary | Enhanced physiologic tremor exacerbated by caffeine; all tremor types may be worsened by caffeine | N/A :: Dietary :: continuous :: Reduce caffeine intake gradually to avoid withdrawal headache; target <200 mg/day or elimination; educate on hidden caffeine sources (chocolate, energy drinks, medications) | None | Tremor severity with caffeine reduction; withdrawal symptoms (headache, fatigue for 1-2 weeks) | ROUTINE | ROUTINE | ROUTINE | - |
| Weighted utensils and adaptive equipment | Device | Functional impairment with eating, writing, or ADLs due to hand tremor of any etiology | N/A :: Device :: as needed :: Weighted utensils, stabilizing spoons (Liftware), weighted pens, two-handled cups, button hooks, rocker knives; OT can assist with selection and training | None | OT assessment and follow-up; functional improvement | - | ROUTINE | ROUTINE | - |
| Wrist weights | Device | Reduce tremor amplitude during activities; kinetic and postural tremor | N/A :: Device :: as needed :: 1-2 lb wrist weights during functional activities; may cause fatigue with prolonged use | None | May cause arm fatigue; not for prolonged continuous use | - | - | ROUTINE | - |
| Stress management and relaxation techniques | Behavioral | Stress, anxiety, and fatigue exacerbate all tremor types; anxiety may be the primary driver in enhanced physiologic tremor | N/A :: Behavioral :: daily :: Deep breathing exercises, progressive muscle relaxation, mindfulness meditation, biofeedback; formal CBT if anxiety is prominent | None | Tremor severity correlation with stress levels; consider formal psychiatric referral if anxiety disorder identified | - | ROUTINE | ROUTINE | - |
...
| Movement disorders specialist referral for diagnostic uncertainty after initial neurology evaluation, DaTscan interpretation, tremor refractory to first-line therapy, or consideration of interventional treatments (DBS, MRgFUS) | - | ROUTINE | ROUTINE |
...
| Neuropsychology if cognitive concerns in addition to tremor (may suggest neurodegenerative process) | - | - | ROUTINE |

### 4B. Patient Instructions

| Recommendation | ED | HOSP | OPD |
|----------------|:--:|:----:|:---:|
| Return immediately for sudden worsening of tremor with new weakness, speech changes, vision changes, or difficulty walking (may indicate stroke or structural brain lesion) | STAT | STAT | ROUTINE |
| Return immediately for high fever with severe rigidity and altered consciousness (may indicate neuroleptic malignant syndrome if on antipsychotics) | STAT | STAT | ROUTINE |
...
| Bring a complete list of ALL medications (prescription, OTC, herbal, supplements) to every appointment as many common medications can cause tremor | ROUTINE | ROUTINE | ROUTINE |
...
| Do not self-medicate with alcohol; while alcohol may temporarily reduce essential tremor, it is not a treatment and chronic use causes permanent cerebellar damage with worsening tremor | ROUTINE | ROUTINE | ROUTINE |
...
| Inform all healthcare providers about your tremor so they can avoid prescribing medications that may worsen it | ROUTINE | ROUTINE | ROUTINE |
...
| Regular exercise (aerobic and strength training) improves overall neurologic health and may reduce tremor severity | - | - | ROUTINE |
...
| Parkinson's disease | Rest tremor (may have postural component with re-emergence) | 4-6 Hz | Unilateral onset → bilateral; "pill-rolling" hands; chin/jaw | Bradykinesia (decrement); rigidity (cogwheel); postural instability; hyposmia; RBD; micrographia | DaTscan reduced uptake; clinical exam (MDS criteria); olfactory testing impaired |
...
| Dystonic tremor | Irregular, jerky, oscillatory | Variable (usually 4-7 Hz) | Focal; in body part affected by dystonia | Irregular amplitude and frequency; "null point" where tremor diminishes; associated dystonic posturing; may have tremor only without obvious dystonia ("tremor associated with dystonia") | Clinical exam (irregular tremor, null point, dystonic posturing); DaTscan normal; botulinum toxin response |
| Psychogenic (functional) tremor | Variable (any type) | Variable; changes with distraction | Any distribution; often bilateral | Variable frequency; entrainment (tremor adopts frequency of contralateral voluntary tapping); distractibility (tremor stops with cognitive tasks); sudden onset; inconsistent pattern; coactivation sign; +/- La Belle indifference | Clinical exam (entrainment test, distraction, loading); DaTscan normal; neuropsychiatric evaluation |
...
| Contralateral voluntary rhythmic tapping during tremor observation | Entrainment (functional tremor) | Tremor frequency shifts to match voluntary tapping frequency → functional |
| Distraction (cognitive task, contralateral complex movement) | Distractibility (functional tremor) | Tremor stops or markedly reduces with distraction → functional |
| Standing with eyes open then closed (Romberg) | Orthostatic tremor assessment | Tremor in legs present ONLY on standing; may feel unsteady without visible tremor |
| Search for "null point" in affected dystonic body part | Dystonic tremor | Tremor diminishes or stops in certain positions → dystonic tremor |
...
|-----------|-----------|------------------|-------------------|:--:|:----:|:---:|:---:|
| Tremor severity (clinical rating: FTM scale, Bain composite score, or spiral drawing) | Each visit; baseline and q3-6 months | Stable or improving with treatment | Worsening → reassess diagnosis; adjust treatment; consider additional workup | - | ROUTINE | ROUTINE | - |
| Neurologic exam (look for emerging signs: bradykinesia, rigidity, ataxia, dystonia) | Each visit | No new neurologic signs developing | New bradykinesia/rigidity → PD evolving; new ataxia → cerebellar pathology; order DaTscan or MRI | - | ROUTINE | ROUTINE | - |
| Functional impact assessment (QUEST, ADL questionnaire) | q6-12 months | Minimal functional impairment | Increasing functional impairment → intensify treatment; therapy referral; consider interventional options | - | - | ROUTINE | - |
| Heart rate and blood pressure | Each visit if on propranolol or other beta-blocker | HR >50 bpm; SBP >90 mmHg | HR <50 or symptomatic bradycardia → reduce dose; SBP <90 → reduce dose or switch agent | - | ROUTINE | ROUTINE | - |
| Handwriting sample / spiral drawing | Each visit | Stable or improved | Progressive deterioration → reassess diagnosis; possible PD evolving or treatment failure | - | ROUTINE | ROUTINE | - |
| TSH (if hyperthyroidism was the cause) | q4-8 weeks until stable, then q6-12 months | Normal (0.4-4.0 mIU/L) | Persistent hyperthyroidism → endocrinology management; tremor should resolve with euthyroid state | - | ROUTINE | ROUTINE | - |
| Drug levels (if on tremor-inducing medications that cannot be discontinued) | Per drug-specific schedule | Therapeutic range | Supratherapeutic → dose reduction; correlate with tremor severity | - | ROUTINE | ROUTINE | - |
| Sedation and cognitive effects (if on primidone, gabapentin, benzodiazepines) | Each visit | Tolerable side effects; no cognitive impairment | Intolerable sedation or cognitive effects → dose reduction or switch agent | - | ROUTINE | ROUTINE | - |
| Wilson disease markers (ceruloplasmin, 24h urine copper) if on chelation therapy | q3-6 months | Improving copper levels; stable neurologic exam | Worsening → hepatology adjustment; neurologic monitoring for chelation-related neurological deterioration | - | ROUTINE | ROUTINE | - |
| Mood and anxiety assessment | Each visit | No significant depression or anxiety | Depression or anxiety → SSRIs (choose agents that do not worsen tremor); psychiatry referral; note that tremor itself causes anxiety (bidirectional relationship) | - | ROUTINE | ROUTINE | - |
| Fall risk assessment | Each visit if gait involved | No falls | Recurrent falls → PT reassessment; home safety evaluation; assistive device | - | ROUTINE | ROUTINE | - |
...
| **Movement disorders specialist referral** | Diagnostic uncertainty after initial neurology evaluation; tremor refractory to first- and second-line medications; consideration for DaTscan interpretation; candidacy for interventional treatment (DBS, MRgFUS, botulinum toxin); suspected functional tremor requiring confirmation |
...
| Primidone equally effective to propranolol for essential tremor; combination may be synergistic | Class I, Level A | [Koller & Vetere-Overfield. Neurology 1989](https://pubmed.ncbi.nlm.nih.gov/2685648/) |
...
| Wilson disease should be excluded in all patients <50 years with new-onset tremor | Class III, Level C | [EASL Clinical Practice Guidelines: Wilson Disease 2012](https://pubmed.ncbi.nlm.nih.gov/22424438/) |
...
| Task Force consensus: tremor evaluation should include classification by activation condition, body distribution, and frequency | Expert consensus | [Deuschl et al. Mov Disord 1998](https://pubmed.ncbi.nlm.nih.gov/9827612/) |
...
- Orthostatic tremor is frequently misdiagnosed; diagnosis requires surface EMG showing characteristic 13-18 Hz frequency; patient may report "unsteadiness" rather than "tremor"
- Alcohol responsiveness is characteristic of essential tremor but is NOT a recommended treatment strategy and should not be encouraged
...
| Cardiac | Amiodarone, procainamide | Postural tremor; intention | May persist after discontinuation (amiodarone long half-life) |

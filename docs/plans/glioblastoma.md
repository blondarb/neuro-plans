...
**CPT CODES:** 85025 (CBC with differential), 80053 (CMP (BMP + LFTs)), 82947 (Blood glucose), 84443 (TSH), 81025 (Pregnancy test (women of childbearing age)), 83036 (HbA1c), 83615 (LDH), 84484 (Troponin), 82550 (CPK/CK), 82533 (Cortisol (AM)), 84134 (Prealbumin / Albumin), 87389 (HIV), 82140 (Ammonia), 70450 (CT head without contrast), 70553 (MRI brain with and without contrast (gadolinium)), 93000 (ECG (12-lead)), 71046 (Chest X-ray), 76390 (MR spectroscopy (MRS)), 70554 (Functional MRI (fMRI)), 78816 (PET/CT (FDG or amino acid-based: FET, FDOPA)), 62270 (LUMBAR PUNCTURE), 89051 (Cell count (tubes 1 and 4)), 84157 (Protein), 82945 (Glucose with serum glucose), 88104 (Cytology), 88184 (Flow cytometry)

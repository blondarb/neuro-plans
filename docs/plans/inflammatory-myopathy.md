...
**CPT CODES:** 82550 (Creatine kinase (CK)), 80053 (CMP (BMP + LFTs)), 85025 (CBC with differential), 82085 (Aldolase), 85652 (ESR), 86140 (CRP), 83615 (LDH), 84450 (AST), 82947 (Blood glucose), 83036 (HbA1c), 81001 (Urinalysis with microscopy), 84443 (TSH), 83735 (Magnesium), 84100 (Phosphorus), 85610 (PT/INR), 86235 (Myositis-specific antibody panel (comprehensive)), 86038 (ANA), 86255 (Anti-dsDNA), 83874 (Myoglobin (serum)), 84484 (Troponin I (cardiac-specific)), 83880 (BNP/NT-proBNP), 82728 (Ferritin), 80074 (Hepatitis B surface antigen, anti-HBc), 87389 (HIV 1/2 antigen/antibody), 82306 (Vitamin D (25-OH)), 86334 (SPEP with immunofixation), 73721 (MRI thighs with and without contrast (bilateral)), 71046 (Chest X-ray (PA and lateral)), 71250 (CT chest high-resolution (HRCT) without contrast), 93000 (ECG (12-lead)), 93306 (Echocardiogram), 73221 (MRI pelvis and proximal upper extremities), 74177 (CT chest/abdomen/pelvis with contrast), 78816 (PET/CT (FDG)), 75561 (Cardiac MRI with contrast), 74220 (Barium swallow / Modified barium swallow), 91010 (Esophageal manometry), 77067 (Mammography and/or breast MRI), 45378 (Colonoscopy), 76856 (Pelvic ultrasound (female patients)), 84153 (PSA (male patients)), 93451 (Right heart catheterization), 96365 (Methylprednisolone IV (pulse therapy)), 36514 (Plasmapheresis (PLEX))

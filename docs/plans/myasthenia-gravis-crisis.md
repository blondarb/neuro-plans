...
| --- | --- | --- | --- | --- | --- | :--: | :--: | :--: | :--: |
| IVIG (intravenous immunoglobulin) (CPT 96365) | IV | First-line immunotherapy for myasthenic crisis or severe exacerbation | 0.4 g/kg :: IV :: daily x 5 days :: 0.4 g/kg/day IV x 5 days (total 2 g/kg) OR 1 g/kg/day x 2 days (faster option). Start within 24h of crisis recognition | IgA deficiency (anaphylaxis risk — use IgA-depleted product); renal failure; thrombotic risk | Vital signs q15min first infusion; renal function daily; headache (aseptic meningitis); thrombotic events | - | STAT | - | STAT |
| Plasmapheresis (PLEX) (CPT 36514) | - | First-line immunotherapy for crisis; preferred in MuSK-positive MG | N/A :: - :: once :: 5 exchanges over 10-14 days (every other day); 1-1.5 plasma volumes per exchange. PREFERRED for MuSK-positive MG. Faster onset than IVIG (days vs 1-2 weeks) | Hemodynamic instability, severe sepsis, heparin allergy, poor vascular access | BP continuous during exchange; Ca2+ (citrate toxicity); fibrinogen; electrolytes; line infection | - | STAT | - | STAT |
| Intubation and mechanical ventilation | - | Respiratory failure from myasthenic crisis (FVC <20 mL/kg) | 20 mL/kg :: - :: - :: Indications: FVC <20 mL/kg, NIF >-30 cmH2O (weaker), >30% FVC decline, clinical distress, inability to handle secretions. Use NON-DEPOLARIZING agents at REDUCED DOSE (MG patients are sensitive). Avoid succinylcholine (unpredictable response) | N/A (life-saving) | Ventilator per ICU protocol; daily SBT when improving | STAT | STAT | - | STAT |
| Hold pyridostigmine during crisis | - | Reduce secretions and prevent cholinergic complications during intubation | N/A :: - :: per protocol :: HOLD cholinesterase inhibitors during intubation/crisis — excess cholinergic stimulation increases secretions and complicates ventilator management. Resume at reduced dose during weaning | N/A | Secretion management; restart when extubation approaching | STAT | STAT | - | STAT |
| Supplemental oxygen | - | Hypoxemia from respiratory muscle weakness | 94% :: - :: - :: As needed for SpO2 <94% | N/A | SpO2 monitoring | STAT | STAT | - | STAT |
| IV fluids (isotonic) | IV | Maintenance hydration and renal protection during IVIG | N/A :: IV :: per protocol :: NS maintenance; hydration for IVIG renal protection | Volume overload | I/O, electrolytes | STAT | STAT | - | STAT |
...
| Treatment | Route | Indication | Dosing | Contraindications | Monitoring | ED | HOSP | OPD | ICU |
| --- | --- | --- | --- | --- | --- | :--: | :--: | :--: | :--: |
| IV methylprednisolone (CPT 96365) | IV | High-dose immunosuppression for severe or refractory MG exacerbation | 1000 mg :: IV :: daily :: 1000 mg IV daily x 3-5 days. CAUTION: steroids can transiently worsen MG in first 5-10 days — only initiate in monitored setting with respiratory support available. Some centers use slow oral prednisone uptitration instead | Uncontrolled diabetes (relative), active infection (relative) | FVC/NIF closely; glucose q6h; BP; GI prophylaxis | - | URGENT | - | URGENT |
| Prednisone (oral uptitration) | PO | Oral immunosuppression with gradual uptitration to reduce transient worsening | 10-20 mg :: PO :: daily :: Start 10-20 mg PO daily; increase by 10 mg every 3-5 days to target 1 mg/kg/day (max 60-80 mg); maintain for 4-8 weeks, then slow taper over months | Active infection, uncontrolled DM (relative) | Glucose, BP, weight, bone density, mood; GI prophylaxis; PJP prophylaxis if prolonged high-dose | - | ROUTINE | ROUTINE | - |
| Second course IVIG or PLEX | - | Inadequate response to initial immunotherapy course | N/A :: - :: per protocol :: Repeat standard dosing if inadequate response to first course; wait 2-4 weeks between courses | Same as initial | Same as initial | - | URGENT | - | URGENT |
| Eculizumab | IV | Refractory AChR-positive generalized MG unresponsive to standard therapy | 900 mg :: IV :: - :: 900 mg IV q1 week x 4 weeks, then 1200 mg IV q2 weeks; for AChR-positive refractory generalized MG | Unresolved Neisseria meningitidis infection; must vaccinate ≥2 weeks before starting | Meningococcal infection; complement levels; CBC | - | EXT | ROUTINE | - |
| Efgartigimod (Vyvgart) | IV | AChR-positive generalized MG with insufficient response to conventional therapy | 10 mg/kg :: IV :: - :: 10 mg/kg IV weekly x 4 weeks per cycle; repeat cycles based on clinical response; for AChR-positive generalized MG | Active infection, IgG <2 g/L | IgG levels (target reduction); infection signs; CBC | - | EXT | ROUTINE | - |
| Rituximab | IV | Refractory MG, especially MuSK-positive disease | 375 mg/m2 :: IV :: - :: 375 mg/m2 IV weekly x 4 weeks OR 1000 mg IV x 2 doses 2 weeks apart; especially effective in MuSK-positive MG | Active infection, hepatitis B (reactivation risk — screen first) | CD20 count, immunoglobulins q3 months; hepatitis B screening; PML risk (rare) | - | EXT | ROUTINE | - |

### 3D. Disease-Modifying or Chronic Therapies

| Treatment | Route | Indication | Dosing | Pre-Treatment Requirements | Contraindications | Monitoring | ED | HOSP | OPD | ICU |
| --- | --- | --- | --- | --- | --- | --- | :--: | :--: | :--: | :--: |
| Azathioprine | PO | First-line steroid-sparing agent for long-term MG immunosuppression | 50 mg :: PO :: daily :: Start 50 mg PO daily; increase by 50 mg every 1-2 weeks to target 2-3 mg/kg/day; onset of effect 6-12 months | - | TPMT deficiency; pregnancy; concurrent allopurinol (dose reduce by 75%) | CBC weekly x 4 weeks, then biweekly x 2 months, then monthly; LFTs monthly x 3, then q3 months | - | ROUTINE | ROUTINE | - |
| Mycophenolate mofetil | PO | Steroid-sparing immunosuppression for generalized MG maintenance | 500 mg :: PO :: BID :: Start 500 mg PO BID; increase to 1000 mg PO BID after 2 weeks; max 1500 mg BID; onset 6-12 months | - | Pregnancy (Category D), breastfeeding | CBC q1 week x 1 month, then biweekly x 2 months, then monthly; LFTs q3 months | - | ROUTINE | ROUTINE | - |
| Tacrolimus | PO | Alternative steroid-sparing agent for MG when first-line agents fail | 3 mg :: PO :: daily :: 3 mg PO daily in 2 divided doses; target trough 5-10 ng/mL; onset 3-6 months | - | Renal failure, uncontrolled hypertension | Trough level q1 week initially, then monthly; Cr, K+, glucose, BP; drug interactions (CYP3A4) | - | - | ROUTINE | - |
| Cyclosporine | PO | Second-line steroid-sparing immunosuppression for refractory MG | 2-3 mg/kg :: PO :: - :: Start 2-3 mg/kg/day PO in 2 divided doses; target trough 100-200 ng/mL; onset 3-6 months | - | Renal failure, uncontrolled HTN, malignancy | Trough levels, Cr, BP, Mg, lipids monthly | - | - | ROUTINE | - |

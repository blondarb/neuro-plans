...
| --- | --- | --- | --- | --- | --- | :--: | :--: | :--: | :--: |
| IV alteplase (tPA) (CPT 96365) | IV | Acute ischemic stroke within 4.5h of last known well | 0.9 mg/kg :: IV :: once :: 0.9 mg/kg IV (max 90 mg); 10% as bolus over 1 min, remaining 90% infused over 60 min. Door-to-needle target <45 min | >4.5h from last known well (relative 3-4.5h window with additional exclusions); BP >185/110 despite treatment; platelets <100K; INR >1.7; active bleeding; recent surgery <14 days; recent stroke <3 months; intracranial hemorrhage history | Neuro checks q15min during infusion, q30min x 6h, then q1h x 18h; BP q15min x 2h, q30min x 6h, then q1h; hold anticoagulants/antiplatelets 24h | STAT | STAT | - | STAT |
| Tenecteplase IV (CPT 96374) | IV | Acute ischemic stroke; Class I alternative to alteplase (single-bolus) | 0.25 mg/kg :: IV :: once :: 0.25 mg/kg IV single bolus (max 25 mg); Class I recommendation per AHA/ASA 2026 guidelines as non-inferior alternative to alteplase for all eligible patients; single-bolus administration simplifies workflow and is preferred when endovascular thrombectomy is planned | Same as alteplase | Same as alteplase | STAT | STAT | - | STAT |
| Endovascular thrombectomy | - | Large vessel occlusion (ICA, M1, M2, basilar); within 24h if eligible | N/A :: - :: once :: For LVO (ICA, M1, M1-M2 junction, select M2, basilar artery); 0-6h: NIHSS ≥6, ASPECTS ≥6 (ASPECTS 3-5 may be eligible per RESCUE-Japan LIMIT and SELECT2 trials — discuss with neurointerventionalist). 6-24h: clinical-core mismatch on perfusion imaging per DAWN/DEFUSE-3 criteria. Basilar artery occlusion: within 24h per ATTENTION and BAOCHE trials | Large completed infarct without salvageable tissue; no LVO; poor premorbid function (mRS >2 relative); life expectancy <6 months | Continuous monitoring in neuro-ICU post-procedure; groin check; BP per post-thrombectomy protocol | STAT | STAT | - | STAT |
| Aspirin | PO | Acute ischemic stroke; antiplatelet (after tPA: wait 24h + CT) | 325 mg :: PO :: daily :: 325 mg PO/PR load (give within 24-48h of onset); if tPA given, wait 24h and obtain CT before starting. Maintenance: 81-325 mg daily | Active GI bleed, true aspirin allergy, within 24h of tPA (wait for post-tPA CT) | GI symptoms, bleeding signs | STAT | STAT | - | STAT |
| Blood pressure management PRE-tPA: Labetalol IV (CPT 96374) | IV | Pre-tPA BP reduction; target <185/110 | 10-20 mg :: IV :: once :: 10-20 mg IV over 1-2 min; may repeat once; target BP <185/110 before tPA | Heart block (2nd/3rd degree), severe bradycardia, decompensated HF, asthma/severe COPD | Heart rate, BP continuous | STAT | STAT | - | STAT |
| Blood pressure management PRE-tPA: Nicardipine IV (CPT 96365) | IV | Pre-tPA BP reduction; sustained infusion option | 5 mg/h :: IV :: - :: 5 mg/h IV infusion; increase by 2.5 mg/h q5-15min; max 15 mg/h; target BP <185/110 | Severe aortic stenosis | BP continuous monitoring | STAT | STAT | - | STAT |
| Blood pressure management PRE-tPA: Clevidipine IV (CPT 96365) | IV | Pre-tPA BP reduction; ultra-short-acting alternative | 1-2 mg/h :: IV :: - :: 1-2 mg/h IV; titrate by doubling q90sec initially; max 32 mg/h | Soy/egg allergy, severe lipid disorders, defective lipid metabolism | BP continuous monitoring | STAT | STAT | - | STAT |
| Blood pressure management POST-tPA (24h) | IV | Post-tPA BP control; target <180/105 for 24h | N/A :: IV :: continuous :: Target BP <180/105 x 24h post-tPA; use nicardipine or labetalol drip as above | See individual agents above | Neuro checks with each BP check; hold if SBP <100 | - | STAT | - | STAT |
| Permissive hypertension (no tPA given) | - | Non-tPA acute stroke; maintain cerebral perfusion | 15% :: - :: - :: Allow BP up to 220/120; treat only if >220/120 or end-organ damage (ACS, aortic dissection, hypertensive encephalopathy). Lower by 15% in first 24h | N/A | Neuro checks; avoid precipitous drops | STAT | STAT | - | STAT |
| IV normal saline | IV | Volume resuscitation; euvolemia maintenance in acute stroke | N/A :: IV :: per protocol :: Isotonic fluids; avoid dextrose-containing solutions (hyperglycemia worsens outcomes); avoid hypotonic solutions (cerebral edema risk) | Volume overload | I/O, electrolytes | STAT | STAT | - | STAT |
| Supplemental oxygen | - | Hypoxemia (SpO2 <94%); avoid routine O2 if normoxic | 94% :: - :: - :: Only if SpO2 <94%; nasal cannula or mask as needed | N/A | SpO2 target ≥94%; avoid routine supplemental O2 if normoxic | STAT | STAT | - | STAT |
...
| Treatment | Route | Indication | Dosing | Contraindications | Monitoring | ED | HOSP | OPD | ICU |
| --- | --- | --- | --- | --- | --- | :--: | :--: | :--: | :--: |
| Dual antiplatelet therapy (DAPT): Aspirin + Clopidogrel | PO | Minor stroke (NIHSS ≤3) or high-risk TIA; 21-day course | 81 mg :: - :: daily :: Aspirin 81 mg + Clopidogrel 75 mg daily x 21 days (minor stroke NIHSS ≤3 or high-risk TIA ABCD2 ≥4); then single antiplatelet long-term. Load clopidogrel 300 mg if not previously on it | Major stroke (NIHSS >3), high bleeding risk, planned surgery | Bleeding signs; CBC | - | URGENT | URGENT | - |
| Dual antiplatelet therapy: Aspirin + Ticagrelor | PO | Minor stroke (NIHSS ≤5); 30-day course (THALES trial) | 81 mg :: PO :: daily :: Aspirin 81 mg daily + Ticagrelor 90 mg BID x 30 days (THALES trial: minor stroke NIHSS ≤5); then single antiplatelet | Intracranial stenosis (may use), high bleeding risk, hepatic impairment | Bleeding signs; dyspnea (common side effect) | - | URGENT | URGENT | - |
| Heparin IV drip (therapeutic) | IV | High re-embolization risk; arterial dissection; crescendo TIA | 60-80 units/kg :: IV :: once :: Bolus 60-80 units/kg (max 5000u); infusion 12-18 units/kg/h; target aPTT 1.5-2.5x control. Use for: cardiac source with high re-embolization risk, arterial dissection, crescendo TIA, free-floating thrombus | Large infarct (hemorrhagic transformation risk), uncontrolled BP, within 24h of tPA | aPTT q6h until stable, then q12-24h; platelets q3 days; neuro checks | - | URGENT | - | URGENT |
| Decompressive craniectomy (malignant MCA infarct) | - | Malignant MCA infarct with >50% territory; age <60 preferred | 50% :: - :: - :: For malignant MCA syndrome with >50% MCA territory infarct, age <60 preferred; within 48h of onset; reduces mortality from 70-80% to ~20% | Age >60 (relative — DESTINY II showed benefit up to age 80 but with higher disability); bilateral infarcts; hemorrhagic transformation | Post-operative neuro checks, ICP monitoring, wound care | - | - | - | STAT |
| Osmotherapy: Mannitol 20% | IV | Acute cerebral herniation from malignant edema | 1-1.5 g/kg :: IV :: once :: 1-1.5 g/kg IV bolus for acute herniation; 0.25-0.5 g/kg q4-6h maintenance | Anuria, severe dehydration | Serum osmolality (hold if >320 mOsm/kg), osmolar gap, renal function, I/O | - | - | - | STAT |
| Osmotherapy: Hypertonic saline 23.4% | IV | Acute cerebral herniation; via central line | 30 mL :: IV :: once :: 30 mL IV bolus via central line over 10-20 min for acute herniation | No central access for 23.4%; hypokalemia | Serum sodium (target 145-155 mEq/L), osmolality, central line integrity | - | - | - | STAT |
| Hypertonic saline 3% infusion | IV | Cerebral edema management; target Na 145-155 | 150-500 mL :: IV :: continuous :: 150-500 mL IV bolus or continuous infusion 0.5-1 mL/kg/h; target Na 145-155 | Hypernatremia, volume overload | Serum sodium q4-6h, osmolality | - | - | - | STAT |

### 3D. Disease-Modifying / Chronic Therapies

| Treatment | Route | Indication | Dosing | Pre-Treatment Requirements | Contraindications | Monitoring | ED | HOSP | OPD | ICU |
| --- | --- | --- | --- | --- | --- | --- | :--: | :--: | :--: | :--: |
| Atorvastatin | PO | Secondary stroke prevention; high-intensity statin (SPARCL trial) | 80 mg :: PO :: daily :: 80 mg PO daily (high-intensity); start within 24-48h regardless of baseline LDL | - | Active liver disease, pregnancy, breastfeeding | LFTs at 12 weeks then annually; lipid panel at 4-12 weeks; CK if myalgia | - | STAT | ROUTINE | STAT |
| Rosuvastatin | PO | Secondary stroke prevention; high-intensity statin alternative | 20-40 mg :: PO :: daily :: 20-40 mg PO daily (high-intensity alternative) | - | Active liver disease, pregnancy, CrCl <30 for 40mg | Same as atorvastatin | - | STAT | ROUTINE | STAT |
| Apixaban | PO | AF-related stroke; DOAC anticoagulation (preferred) | 5 mg :: PO :: BID :: 5 mg PO BID (2.5 mg BID if ≥2 of: age ≥80, weight ≤60kg, Cr ≥1.5); start 4-14 days post-stroke for AF (timing based on infarct size). Preferred DOAC per guidelines | - | Renal function; bleeding signs; CBC | - | - | ROUTINE | ROUTINE | - |
| Rivaroxaban | PO | AF-related stroke; once-daily DOAC | 20 mg :: PO :: daily :: 20 mg PO daily with evening meal (15 mg daily if CrCl 15-50); start 4-14 days post-stroke for AF | - | Renal function q6-12 months; bleeding signs | - | - | ROUTINE | ROUTINE | - |
| Dabigatran | PO | AF-related stroke; DOAC with reversal agent (idarucizumab) | 150 mg :: PO :: BID :: 150 mg PO BID (75 mg BID if CrCl 15-30); start 4-14 days post-stroke for AF | - | Renal function q6-12 months; bleeding signs; GI side effects | - | - | ROUTINE | ROUTINE | - |
| Warfarin | PO | AF-related stroke; mechanical valve (INR 2.5-3.5); DOAC unavailable | 5 mg :: PO :: daily :: 5 mg PO daily initial (2-3 mg if elderly, low weight, or interacting drugs); target INR 2.0-3.0 for AF; 2.5-3.5 for mechanical valve. Bridge with heparin | - | INR daily until stable, then weekly, then monthly; diet counseling (vitamin K) | - | - | ROUTINE | ROUTINE | - |
| Lisinopril | PO | Secondary stroke prevention; BP target <130/80 | 5-10 mg :: PO :: daily :: Start 5-10 mg PO daily; titrate to 20-40 mg daily; target BP <130/80 after acute phase | - | Cr and K+ at 1-2 weeks after initiation; BP | - | - | ROUTINE | ROUTINE | - |
| Amlodipine | PO | Secondary stroke prevention; antihypertensive | 5 mg :: PO :: daily :: Start 5 mg PO daily; max 10 mg daily | - | BP, peripheral edema | - | - | ROUTINE | ROUTINE | - |
| Losartan | PO | Secondary stroke prevention; ACE-I intolerant | 50 mg :: PO :: daily :: Start 50 mg PO daily; max 100 mg daily | - | Cr, K+, BP | - | - | ROUTINE | ROUTINE | - |
| Metoprolol succinate | PO | Secondary stroke prevention; rate control if concurrent AF | 25 mg :: PO :: daily :: Start 25 mg PO daily; titrate to 200 mg daily | - | HR, BP | - | - | ROUTINE | ROUTINE | - |
| Ezetimibe | PO | LDL not at goal on max statin; add-on lipid lowering | 10 mg :: PO :: daily :: 10 mg PO daily; add if LDL not at goal on max statin | - | LFTs, lipid panel | - | - | ROUTINE | ROUTINE | - |
| PCSK9 inhibitor (evolocumab) | SC | LDL not at goal on max statin + ezetimibe | 140 mg :: SC :: monthly :: 140 mg SC q2 weeks or 420 mg SC monthly; if LDL not at goal on max statin + ezetimibe | - | Lipid panel q4-12 weeks; injection site reactions | - | - | - | ROUTINE | - |
...
|----------------|----------------|--------|
| IV alteplase within 4.5h | Class I, Level A | [AHA/ASA 2026 AIS Guidelines (Prabhakaran et al.)](https://pubmed.ncbi.nlm.nih.gov/41582814/); [NINDS trial (NEJM 1995)](https://pubmed.ncbi.nlm.nih.gov/7477192/); [ECASS III (Hacke et al. NEJM 2008)](https://pubmed.ncbi.nlm.nih.gov/18815396/) |
| Tenecteplase non-inferior to alteplase (all eligible patients) | Class I, Level A | [AHA/ASA 2026 AIS Guidelines (Prabhakaran et al.)](https://pubmed.ncbi.nlm.nih.gov/41582814/); [AcT trial (Menon et al. Lancet 2022)](https://pubmed.ncbi.nlm.nih.gov/35779553/); [EXTEND-IA TNK](https://pubmed.ncbi.nlm.nih.gov/29694815/) |
...
| Thrombectomy for basilar artery occlusion | Class I, Level A | [ATTENTION (Tao et al. NEJM 2022)](https://pubmed.ncbi.nlm.nih.gov/36239645/); [BAOCHE (Jovin et al. NEJM 2022)](https://pubmed.ncbi.nlm.nih.gov/36239644/) |
| Thrombectomy for large core infarcts (ASPECTS 3-5) | Class IIa, Level B-R | [RESCUE-Japan LIMIT (Yoshimura et al. NEJM 2022)](https://pubmed.ncbi.nlm.nih.gov/36083649/); [SELECT2 (Sarraj et al. NEJM 2023)](https://pubmed.ncbi.nlm.nih.gov/36762865/) |
...
| Dysphagia screening before PO intake | Class I, Level B-NR | [AHA/ASA 2026 AIS Guidelines (Prabhakaran et al.)](https://pubmed.ncbi.nlm.nih.gov/41582814/) |
...
| Permissive hypertension (up to 220/120 if no tPA) | Class I, Level B-R | [AHA/ASA 2026 AIS Guidelines (Prabhakaran et al.)](https://pubmed.ncbi.nlm.nih.gov/41582814/) |
| Target glucose 140-180 mg/dL | Class I, Level C | [AHA/ASA 2026 AIS Guidelines (Prabhakaran et al.)](https://pubmed.ncbi.nlm.nih.gov/41582814/) |
| DVT prophylaxis within 24-48h | Class I, Level A | [AHA/ASA 2026 AIS Guidelines (Prabhakaran et al.)](https://pubmed.ncbi.nlm.nih.gov/41582814/) |
| Depression screening post-stroke | Class I, Level B-NR | [AHA/ASA 2026 AIS Guidelines (Prabhakaran et al.)](https://pubmed.ncbi.nlm.nih.gov/41582814/) |
| Normothermia maintenance | Class I, Level C | [AHA/ASA 2026 AIS Guidelines (Prabhakaran et al.)](https://pubmed.ncbi.nlm.nih.gov/41582814/) |
...
| 6 | Standard threshold for thrombectomy eligibility (0-6h window) |
| 3-5 | Large core; thrombectomy may be considered in select patients (RESCUE-Japan LIMIT, SELECT2 trials) — discuss with neurointerventionalist |
| <3 | Very large established infarct; higher hemorrhagic transformation risk; thrombectomy generally not recommended |

...
**CPT CODES:** 85025 (CBC with differential), 80053 (CMP), 86255 (P/Q-type VGCC antibody), 85652 (ESR), 86140 (CRP), 84443 (TSH), 82947 (Blood glucose), 83036 (HbA1c), 83735 (Magnesium), 82310 (Calcium), 84100 (Phosphorus), 85610 (PT/INR), 81003 (Urinalysis), 83615 (LDH), 86235 (AChR binding antibody), 80074 (Hepatitis B surface antigen), 87389 (HIV), 82306 (Vitamin D (25-OH)), 84153 (PSA (males >50)), 82378 (CEA), 86334 (SPEP with immunofixation), 71260 (CT chest with contrast), 71046 (Chest X-ray (PA and lateral)), 78816 (PET/CT (FDG)), 93000 (ECG (12-lead)), 95937 (Repetitive nerve stimulation (RNS) - low rate (2-3 Hz)), 95872 (Single-fiber EMG (SFEMG)), 95921-95924 (Autonomic function testing), 70553 (MRI brain with contrast), 96365 (IVIg (intravenous immunoglobulin)), 36514 (Plasma exchange (PLEX))

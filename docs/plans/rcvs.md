...
**CPT CODES:** 85025 (CBC with differential), 80053 (CMP (BMP + LFTs)), 85652 (ESR), 86140 (CRP), 84703 (Pregnancy test (beta-hCG)), 80307 (Urine drug screen), 84443 (TSH), 83735 (Magnesium), 84484 (Troponin), 86235 (ANA), 86592 (Syphilis screen (RPR/VDRL)), 87389 (HIV screen), 84260 (Serum serotonin), 82164 (ACE level), 70450 (CT head without contrast), 70496 (CT angiography head (CTA)), 70551 (MRI brain without contrast), 70544 (MRA head), 93000 (ECG (12-lead)), 70553 (MRI brain with and without contrast), 36224 (Conventional cerebral angiography (DSA)), 93886 (Transcranial Doppler (TCD)), 93306 (Echocardiogram (TTE)), 62270 (LUMBAR PUNCTURE), 89051 (Cell count (tubes 1 and 4)), 84157 (Protein), 82945 (Glucose with serum glucose), 88108 (Cytology)
...
| Calcium channel blockers (verapamil, nimodipine) as mainstay therapy | Class III, Level C | [Ducros et al. Brain 2007](https://pubmed.ncbi.nlm.nih.gov/18025032/); Singhal et al. Neurology 2011 — observational data; no RCTs available |
...
| Transcranial Doppler for non-invasive monitoring of vasoconstriction | Class III, Level C | [Chen et al. Ann Neurol 2011](https://pubmed.ncbi.nlm.nih.gov/21437936/) — TCD changes correlate with angiographic findings |
...
- Reordered all lab table columns (1A, 1B, 1C) to place venue columns (ED, HOSP, OPD, ICU) last per style guide
- Reordered all imaging table columns (2A, 2B, 2C) to place venue columns last per style guide
- Reordered LP studies table columns to place venue columns last per style guide
- Reordered Section 6 Monitoring table columns to place venue columns last per style guide
- Standardized structured dosing format across all treatment tables (3A, 3B, 3C, 3D) to use single standard dose before :: delimiter
- Added ICU column to Section 4B (Patient Instructions) for four-venue consistency
- Added ICU column to Section 4C (Lifestyle & Prevention) for four-venue consistency
- No clinical content changes; all dosing, contraindications, and monitoring unchanged

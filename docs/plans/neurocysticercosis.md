...
**CPT CODES:** 86682 (Cysticercosis antibody), 87015 (CSF concentration for infectious agents), 86235 (Nuclear antibody, extractable), 70553 (MRI brain with/without contrast), 70460 (CT head with contrast), 70450 (CT head without contrast), 95816 (EEG routine), 95819 (EEG with sleep), 95700-95720 (continuous EEG), 89051 (CSF cell count with differential), 84157 (CSF protein), 82945 (CSF glucose), 87205 (Gram stain), 96374 (IV push injection), 96365 (IV infusion), 96360 (IV hydration), 96372 (SC/IM injection), 61510 (craniotomy for excision), 62270 (lumbar puncture), 62160 (neuroendoscopy), 62200 (ventriculostomy), 62223 (VP shunt), 61210 (EVD placement), 61140 (brain biopsy), 88305 (surgical pathology), 70551 (MRI brain without contrast), 72156 (MRI spine with/without contrast), 93000 (ECG), 93306 (echocardiogram), 78816 (PET-CT), 92002-92014 (ophthalmologic exam)
...
| Histopathology of excised cyst (CPT 88305) | - | ROUTINE | - | - | **Gold standard** per Del Brutto absolute criteria; identifies scolex, cyst wall, hooklets; confirms T. solium species; from surgical excision or endoscopic removal | Parasitic structures: scolex with rostellar hooklets, cyst wall with tegument and subtegumental cells |
| Brain biopsy / cyst excision with pathology (CPT 61140+88305) | - | EXT | - | - | When diagnosis uncertain despite imaging and serology; to differentiate from tumor, abscess, or other granulomatous disease | Cysticercus larva identified; parasitic elements within cyst; surrounding inflammatory tissue |
...
| Complement levels (CH50, C3, C4) (CPT 86162+86160) | - | EXT | EXT | - | Subarachnoid NCC triggers complement-mediated vasculitis; monitor if vasculitis suspected | Normal or decreased |
...
| Ophthalmologic examination (fundoscopy) (CPT 92002-92014) | URGENT | STAT | ROUTINE | - | **MANDATORY before starting antiparasitic treatment**; ocular cysticercosis is a contraindication to antiparasitic drugs; treatment-induced inflammation causes blindness | Intraocular cyst (vitreous, retinal, subretinal); papilledema (elevated ICP) | None |
...
| Study | ED | HOSP | OPD | ICU | Timing | Target Finding | Contraindications |
|-------|:--:|:----:|:---:|:---:|--------|----------------|-------------------|
| FIESTA/CISS MRI sequences (3D heavily T2-weighted) (CPT 70553) | - | ROUTINE | ROUTINE | - | For intraventricular cyst visualization; superior to standard MRI for small ventricular and subarachnoid cysts | Intraventricular cyst outline clearly delineated; scolex visible; cyst relationship to ventricular walls and foramina | Same as MRI brain |
| Phase-contrast cine MRI (CPT 70553) | - | EXT | - | - | If mobile intraventricular cyst suspected (ball-valve hydrocephalus); demonstrates cyst mobility with CSF flow | Mobile cyst causing intermittent foramen obstruction | Same as MRI brain |
...
| ICP monitoring (EVD) (CPT 61210) | - | - | - | URGENT | Acute hydrocephalus from ventricular cyst obstruction; declining consciousness from cysticercal encephalitis | ICP <22 mmHg; CPP >60 mmHg | Coagulopathy (correct first) |
| Neuroendoscopy (diagnostic/therapeutic) (CPT 62160) | - | URGENT | - | - | Intraventricular cyst removal; direct visualization and excision; avoids open craniotomy | Cyst visualized and excised intact; scolex identified; cyst-free ventricle post-procedure | Coagulopathy; inaccessible cyst location |
...
| Ondansetron (CPT 96374) | IV/PO | Nausea and vomiting (common with elevated ICP and antiparasitic therapy; albendazole commonly causes nausea) | 4 mg :: IV :: q6h PRN :: 4 mg IV/PO q6h PRN nausea; max 16 mg/day | QT prolongation; severe hepatic impairment (max 8 mg/day) | QTc if risk factors; hepatic function | STAT | ROUTINE | ROUTINE | STAT |
| Pantoprazole (CPT 96374) | IV/PO | GI prophylaxis during corticosteroid therapy; stress ulcer prevention in ICU; steroid-induced gastropathy prevention | 40 mg :: IV :: daily :: 40 mg IV/PO daily; discontinue when steroids stopped and no longer in ICU | Long-term use risks (C. diff, hypomagnesemia); only while on steroids | GI symptoms; discontinue when steroids tapered | - | ROUTINE | ROUTINE | ROUTINE |
| Enoxaparin (CPT 96372) | SC | DVT prophylaxis; prolonged hospitalization and immobilization; steroid use increases VTE risk | 40 mg :: SC :: daily :: 40 mg SC daily; start 24h post-surgery if no active bleeding; hold if upcoming surgery | Active intracranial bleeding; recent craniotomy (<24h); coagulopathy; platelets <50K | Platelets q3 days (HIT monitoring); coagulation panel | - | ROUTINE | - | ROUTINE |
...
|----------------|----------------|--------|
| Del Brutto diagnostic criteria for NCC | Class I, Level A | [Del Brutto et al. J Neurol Sci 2017](https://pubmed.ncbi.nlm.nih.gov/28017213/) — revised diagnostic criteria with absolute, major, minor, and epidemiologic criteria |
| Albendazole 15 mg/kg/day for parenchymal NCC | Class I, Level A | [Garcia et al. N Engl J Med 2004](https://pubmed.ncbi.nlm.nih.gov/14724304/) — randomized controlled trial demonstrating albendazole reduces seizure burden and promotes cyst resolution |
| Combination albendazole + praziquantel for >2 viable cysts | Class I, Level A | [Garcia et al. Lancet Infect Dis 2014](https://pubmed.ncbi.nlm.nih.gov/24999157/) — RCT showing combination therapy superior to albendazole alone for multiple cysts |
| Corticosteroids before and during antiparasitic therapy | Class I, Level A | [Garcia et al. N Engl J Med 2004](https://pubmed.ncbi.nlm.nih.gov/14724304/); [IDSA/ASTMH Guidelines — White et al. Clin Infect Dis 2018](https://pubmed.ncbi.nlm.nih.gov/29481580/) |
...
| EITB (immunoblot) as preferred serologic test | Class I, Level A | [Tsang et al. J Infect Dis 1989](https://pubmed.ncbi.nlm.nih.gov/2909643/) — EITB sensitivity 94-98% for >1 viable cyst; specificity ~100% |
| Enzyme-inducing AEDs reduce praziquantel levels by 50-75% | Class I, Level B | [Bittencourt et al. Neurology 1992](https://pubmed.ncbi.nlm.nih.gov/1549207/) — phenytoin and carbamazepine significantly reduce praziquantel bioavailability; prefer non-enzyme-inducing AEDs |
...
| Neuroendoscopy preferred for intraventricular cyst removal | Class IIa, Level B | [Sinha & Sharma. Br J Neurosurg 2012](https://pubmed.ncbi.nlm.nih.gov/22168964/) — endoscopic approach offers direct visualization with lower morbidity than open surgery for ventricular cysts |
...
| Prolonged antiparasitic therapy for subarachnoid NCC | Class IIa, Level C | [Proano et al. N Engl J Med 2001](https://pubmed.ncbi.nlm.nih.gov/11565520/) — subarachnoid (racemose) NCC requires prolonged courses (months); monitor with CSF antigen |
| NCC is the leading cause of adult-onset epilepsy worldwide | Class I, Level A | [Ndimubanzi et al. PLoS Negl Trop Dis 2010](https://pubmed.ncbi.nlm.nih.gov/21072231/) — systematic review confirming NCC accounts for ~30% of epilepsy in endemic areas |
| Methotrexate as steroid-sparing agent for subarachnoid NCC | Class IIb, Level C | [Mitre et al. Clin Infect Dis 2007](https://pubmed.ncbi.nlm.nih.gov/17243058/) — case series supporting methotrexate for chronic arachnoiditis requiring prolonged immunosuppression |
| Albendazole bioavailability increased 5-fold with fatty meal | Class I, Level B | [Lange et al. Eur J Clin Pharmacol 1988](https://pubmed.ncbi.nlm.nih.gov/3396623/) — pharmacokinetic study demonstrating increased systemic availability of albendazole when taken with a fatty meal |
...
| Dexamethasone increases albendazole sulfoxide levels by 50% | Class I, Level B | [Takayanagui et al. Ther Drug Monit 1997](https://pubmed.ncbi.nlm.nih.gov/9029747/) — pharmacokinetic interaction of albendazole sulfoxide with dexamethasone demonstrating increased active metabolite levels |
...
- Citation verification: 12 unique PMIDs audited via NCBI E-utilities API
- Fixed 11 incorrect PMIDs (only White et al. PMID 29481580 was correct)
- Del Brutto PMID corrected: 28320184 -> 28017213
- Garcia NEJM 2004 PMID corrected: 15306668 -> 14724304
- Garcia Lancet Infect Dis 2014 PMID corrected: 25444472 -> 24999157
- Tsang EITB 1989 PMID corrected: 2715568 -> 2909643
- Bittencourt Neurology 1992 PMID corrected: 1549209 -> 1549207
- Sinha & Sharma corrected: journal "Neurosurg Focus" -> "Br J Neurosurg"; PMID 22537130 -> 22168964
- Proano corrected: journal "Ann Intern Med" -> "N Engl J Med"; PMID 11293476 -> 11565520
- Ndimubanzi PLoS Negl Trop Dis 2010 PMID corrected: 21152057 -> 21072231
- Mitre Clin Infect Dis 2007 PMID corrected: 17712753 -> 17243058
- Mottier et al. J Pharm Pharmacol 2006 (PMID 16553415) replaced with verified source: Lange et al. Eur J Clin Pharmacol 1988 (PMID 3396623)
- Jung et al. J Clin Pharmacol 1990 (PMID 2229455) replaced with verified source: Takayanagui et al. Ther Drug Monit 1997 (PMID 9029747)
- CPT enrichment: 20 CPT codes added to labs, imaging, procedures, and IV treatments
- Added CPT to: histopathology (88305), brain biopsy (61140+88305), complement levels (86162+86160), ophthalmologic exam (92002-92014), FIESTA/CISS MRI (70553), phase-contrast cine MRI (70553), ICP monitoring/EVD (61210), neuroendoscopy (62160), hypertonic saline (96365), lorazepam (96374), IV normal saline (96360), fosphenytoin (96374), lacosamide IV (96374), ondansetron (96374), pantoprazole (96374), enoxaparin (96372), neuroendoscopic cyst removal (62160), VP shunt (62223), ETV (62200), craniotomy (61510), EVD (61210)
- Updated header CPT CODES list with all new codes

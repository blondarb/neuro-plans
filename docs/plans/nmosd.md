...
| **Ravulizumab (Ultomiris)** | IV | FDA-approved for AQP4+ NMOSD; long-acting complement C5 inhibitor | Weight-based loading then q8wk :: IV :: q8wk :: Loading dose: 2400-3000 mg IV (weight-based); maintenance: 3000-3600 mg IV every 8 weeks | Same as eculizumab; meningococcal vaccination required | Same as eculizumab | Same as eculizumab; less frequent dosing improves adherence | - | - | ROUTINE | - |
...
- Fixed standard_dose field to contain starting dose only (removed titration steps from first field)
- Added frequency field to all medications (gabapentin, pregabalin, duloxetine, baclofen, tizanidine, oxybutynin, modafinil, sertraline, ondansetron, prednisone taper, IVIG, eculizumab, inebilizumab, satralizumab, rituximab, mycophenolate, azathioprine, tocilizumab)

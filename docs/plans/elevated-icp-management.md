...
| Treatment | Route | Indication | Dosing | Contraindications | Monitoring | ED | HOSP | OPD | ICU |
| --- | --- | --- | --- | --- | --- | :--: | :--: | :--: | :--: |
| Corticosteroids in TBI | IV/PO | CRASH trial: increased mortality in TBI (RR 1.15) | Avoid :: - :: - :: Absolutely contraindicated; worsens cytotoxic edema | TBI with elevated ICP | - | AVOID | AVOID | AVOID | AVOID |
| Corticosteroids in ischemic stroke | IV/PO | No benefit; may worsen outcomes in ischemic stroke | Avoid :: - :: - :: No proven benefit; risk of hyperglycemia and infection | Ischemic stroke | - | AVOID | AVOID | AVOID | AVOID |
| Hypotonic fluids (D5W, 0.45% NaCl) | IV | Worsens cerebral edema; shifts free water into brain parenchyma | Avoid :: IV :: - :: Use isotonic or hypertonic fluids only | All elevated ICP patients | - | AVOID | AVOID | AVOID | AVOID |
| Prolonged aggressive hyperventilation | - | Causes cerebral ischemia and rebound vasodilation | Avoid :: - :: - :: Limit to <30 min for acute herniation only; never PaCO2 <25 | Prophylactic or prolonged use | - | AVOID | AVOID | AVOID | AVOID |
| Ketamine (traditionally) | IV | Traditionally avoided; may raise ICP (emerging data suggest may be safe) | Avoid :: IV :: - :: Avoid in severe uncontrolled ICP; controversial | Severe TBI with uncontrolled ICP | - | AVOID | AVOID | AVOID | AVOID |
| Nitroprusside | IV | Causes cerebral vasodilation and raises ICP | Avoid :: IV :: - :: Use alternative antihypertensives (labetalol, nicardipine) | Elevated ICP with hypertension | - | AVOID | AVOID | AVOID | AVOID |
| Propofol infusion syndrome (prolonged high-dose propofol) | IV | PRIS risk with >48-72h at high doses (>80 mcg/kg/min) | Avoid :: IV :: - :: Limit duration and dose; monitor for metabolic acidosis, rhabdomyolysis | Prolonged high-dose propofol infusion | CK, lactate, triglycerides q24h if >48h use | - | - | - | AVOID |

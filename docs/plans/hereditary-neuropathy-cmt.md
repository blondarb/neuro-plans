...
| Chest X-ray / CT chest | STAT | ROUTINE | EXT | STAT | Screen for diaphragmatic elevation (phrenic nerve involvement in CMT2C/TRPV4); scoliosis assessment; ED/ICU if respiratory distress | Normal; no diaphragm elevation |

### 2C. Pulmonary Function Assessment

| Study | ED | HOSP | OPD | ICU | Rationale | Target Finding |
|-------|:--:|:----:|:---:|:---:|-----------|----------------|
| Spirometry (FVC upright and supine) (CPT 94010) | STAT | ROUTINE | ROUTINE | STAT | Assess respiratory muscle weakness; FVC <80% predicted or >10% drop supine indicates diaphragm weakness; relevant in severe CMT, CMT2C, CMT4; ED/ICU if respiratory distress | FVC >80% predicted; <10% supine drop |
| Echocardiogram (CPT 93306) | - | ROUTINE | ROUTINE | ROUTINE | Screen for cardiomyopathy in LMNA-related CMT2; arrhythmias in selected subtypes; ICU if cardiac concerns | Normal LVEF; no structural abnormalities |
| ECG (CPT 93000) | STAT | ROUTINE | ROUTINE | STAT | Screen for conduction abnormalities; LMNA mutations associated with cardiac conduction disease; baseline before starting TCAs | Normal sinus rhythm; no conduction block |

### LUMBAR PUNCTURE

**Indication:** Differentiate CMT from CIDP when clinical/electrodiagnostic distinction is unclear; evaluate for elevated protein in Dejerine-Sottas disease
**Timing:** ROUTINE in most cases; not typically urgent
**Volume Required:** 10-15 mL (standard diagnostic)

| Study | ED | HOSP | OPD | Rationale | Target Finding |
|-------|:--:|:----:|:---:|-----------|----------------|
| CSF protein | - | ROUTINE | EXT | CMT has normal or mildly elevated protein; CIDP typically >45 mg/dL; Dejerine-Sottas may have markedly elevated protein | Normal (<45 mg/dL) |
| Cell count (tubes 1 and 4) | - | ROUTINE | EXT | Rule out inflammatory process; normal in CMT | WBC <5; RBC 0 |
| CSF glucose | - | ROUTINE | EXT | Normal in CMT; low in infectious/inflammatory meningitis | Normal |
| CSF oligoclonal bands | - | ROUTINE | EXT | Absent in CMT; present in inflammatory conditions (MS, CIDP variant) | Absent |

**Contraindications:** Coagulopathy (INR >1.5); thrombocytopenia (<50,000); posterior fossa mass lesion; skin infection at puncture site
...
| Duloxetine | PO | Neuropathic pain (first-line alternative); also treats comorbid depression and fatigue | 30 mg; 60 mg :: PO :: daily :: Start 30 mg daily for 1 week, then increase to 60 mg daily | Hepatic impairment; concurrent MAOIs; uncontrolled glaucoma | LFTs; serotonin syndrome risk; blood pressure | - | ROUTINE | ROUTINE | - |
| Amitriptyline | PO | Neuropathic pain (second-line); aids sleep | 10 mg; 25 mg; 50 mg :: PO :: nightly :: Start 10 mg nightly, increase by 10 mg weekly to 25-75 mg nightly | Cardiac conduction disease; urinary retention; glaucoma; elderly (fall risk) | ECG if >50 mg/day; anticholinergic effects; QTc | - | ROUTINE | ROUTINE | - |
| Nortriptyline | PO | Neuropathic pain (second-line; better tolerated than amitriptyline in elderly) | 10 mg; 25 mg; 50 mg :: PO :: nightly :: Start 10 mg nightly, increase by 10 mg weekly to 25-75 mg nightly | Cardiac conduction disease; recent MI; urinary retention; glaucoma | ECG if >50 mg/day; anticholinergic effects; QTc | - | ROUTINE | ROUTINE | - |
...
| Mexiletine | PO | Neuropathic pain in CMT (third-line); some evidence in CMT-related pain | 150 mg :: PO :: TID :: Start 150 mg daily, increase to 150 mg TID over 1-2 weeks; max 300 mg TID | Second/third-degree heart block; hepatic impairment | ECG at baseline and with dose changes; LFTs; GI side effects | - | - | EXT | - |
| Quinine sulfate | PO | Muscle cramps (off-label; use with caution) | 200 mg; 324 mg :: PO :: qHS :: 200-324 mg at bedtime; limit duration | Thrombocytopenia; G6PD deficiency; QT prolongation; pregnancy | CBC; QTc monitoring; FDA warning re: serious adverse effects; use only if cramps are disabling | - | - | EXT | - |
| Magnesium oxide | PO | Muscle cramps (first-line, safer alternative) | 400 mg :: PO :: daily :: 400-800 mg daily in divided doses | Renal impairment (accumulation risk) | Renal function; diarrhea is dose-limiting | - | ROUTINE | ROUTINE | - |
| Modafinil | PO | Fatigue (off-label; CMT-related fatigue is underrecognized) | 100 mg; 200 mg :: PO :: daily :: Start 100 mg each morning; increase to 200 mg daily if needed; max 200 mg/day | Severe hepatic impairment; cardiac arrhythmias | Blood pressure; insomnia; headache; Stevens-Johnson syndrome (rare) | - | - | ROUTINE | - |
| Sertraline | PO | Depression/anxiety (common comorbidity in CMT) | 25 mg; 50 mg; 100 mg :: PO :: daily :: Start 25-50 mg daily; increase by 25-50 mg every 1-2 weeks; max 200 mg/day | Concurrent MAOIs; QT prolongation risk | Serotonin syndrome; GI effects; sexual dysfunction; suicidality monitoring in young adults | - | ROUTINE | ROUTINE | - |
| Venlafaxine XR | PO | Depression with comorbid neuropathic pain | 37.5 mg; 75 mg; 150 mg :: PO :: daily :: Start 37.5 mg daily for 1 week, then 75 mg daily; may increase to 150-225 mg daily | Concurrent MAOIs; uncontrolled hypertension | Blood pressure; serotonin syndrome; taper slowly to avoid discontinuation syndrome | - | ROUTINE | ROUTINE | - |
| Baclofen | PO | Muscle spasticity and cramps | 5 mg; 10 mg; 20 mg :: PO :: TID :: Start 5 mg TID, increase by 5 mg/dose every 3 days; max 80 mg/day | Renal impairment (dose adjust); abrupt withdrawal risk (seizures) | Sedation; dizziness; taper slowly to discontinue | - | ROUTINE | ROUTINE | - |
| Tizanidine | PO | Muscle spasticity (alternative to baclofen) | 2 mg; 4 mg :: PO :: TID :: Start 2 mg at bedtime, increase by 2 mg every 3-4 days; max 36 mg/day in divided doses | Hepatic impairment; concurrent fluvoxamine or ciprofloxacin (CYP1A2 inhibitors) | LFTs at baseline, 1, 3, 6 months, then periodically; sedation; hypotension | - | ROUTINE | ROUTINE | - |
...
### 3D. Surgical Management & Emerging Therapies
...
|----------------|:--:|:----:|:---:|:---:|------------|
| Neuromuscular neurology referral | URGENT | URGENT | ROUTINE | URGENT | All suspected or confirmed CMT for diagnosis, genetic testing strategy, and longitudinal management |
| Genetic counseling referral | - | ROUTINE | ROUTINE | - | All confirmed CMT; discuss inheritance pattern (AD, AR, X-linked), family planning, predictive testing for at-risk relatives |
| Physical therapy (PT) consult | - | ROUTINE | ROUTINE | ROUTINE | Strength maintenance, balance training, fall prevention, exercise prescription; avoid eccentric overload |
| Occupational therapy (OT) consult | - | ROUTINE | ROUTINE | - | Hand weakness, fine motor impairment, adaptive equipment, splinting, ADL adaptation |
| Orthotist / Prosthetics referral | - | ROUTINE | ROUTINE | - | Custom AFO fitting for foot drop/ankle instability; hand splints for thenar weakness |
| Podiatry referral | - | ROUTINE | ROUTINE | - | Annual foot examination; early deformity intervention; pes cavus and hammertoe management |
| Orthopedic surgery referral | - | ROUTINE | ROUTINE | - | Progressive foot/ankle deformity unresponsive to orthoses; scapular winging; carpal tunnel |
| Pulmonology referral | - | ROUTINE | ROUTINE | ROUTINE | FVC <80% predicted or respiratory symptoms; diaphragm weakness assessment (CMT2C, CMT4, severe CMT) |
| Cardiology referral | - | ROUTINE | ROUTINE | - | LMNA-related CMT2 (conduction disease, cardiomyopathy); screening ECG/echo abnormalities |
| Pain management referral | - | - | ROUTINE | - | Refractory neuropathic pain not responding to first- and second-line agents |
| Psychiatry / Psychology referral | - | ROUTINE | ROUTINE | - | Depression, anxiety, chronic pain coping, adjustment to progressive disability |
| Vocational rehabilitation referral | - | - | ROUTINE | - | Progressive hand weakness or mobility impairment affecting employment |
| Social work consult | - | ROUTINE | ROUTINE | - | Disability resources, DME assistance, insurance navigation, support group referral |

### 4B. Patient Instructions

| Recommendation | ED | HOSP | OPD |
|----------------|:--:|:----:|:---:|
| Carry neurotoxic medication alert card or wear medical alert bracelet listing CMT diagnosis and vincristine contraindication | ✓ | ✓ | ✓ |
| Return to ED if sudden severe weakness, difficulty breathing, or rapid symptom progression (may indicate superimposed GBS/CIDP) | ✓ | ✓ | ✓ |
| Inform all healthcare providers (including dentists, surgeons, anesthesiologists) of CMT diagnosis before any procedure | ✓ | ✓ | ✓ |
| Inspect feet daily for blisters, cuts, or pressure sores; wear well-fitting protective footwear at all times | - | ✓ | ✓ |
| Use AFOs and assistive devices as prescribed; do not discontinue without PT/physician guidance | - | ✓ | ✓ |
| Exercise regularly at moderate intensity (walking, swimming, cycling); avoid high-resistance eccentric exercise and overexertion | - | ✓ | ✓ |
| Do not stop gabapentin or pregabalin abruptly — taper under medical guidance to avoid withdrawal | - | ✓ | ✓ |
| Report new or worsening numbness, weakness, pain, breathing difficulty, or balance problems promptly | ✓ | ✓ | ✓ |
| Neuropathic pain medications take 2-4 weeks to reach full effect; report side effects before discontinuing | - | ✓ | ✓ |
| Genetic counseling is recommended before family planning; inheritance pattern depends on CMT subtype | - | - | ✓ |
| Contact CMT Foundation (cmtausa.org) for educational materials, support groups, and clinical trial information | - | ✓ | ✓ |

### 4C. Lifestyle & Prevention

| Recommendation | ED | HOSP | OPD |
|----------------|:--:|:----:|:---:|
| Neurotoxic medication avoidance is the single most important actionable step — document prominently in chart and allergy list | ✓ | ✓ | ✓ |
| Moderate aerobic exercise (walking, swimming, cycling) improves fitness and quality of life without worsening neuropathy | - | ✓ | ✓ |
| Weight management — excess weight increases functional burden on weakened muscles and accelerates deformity | - | ✓ | ✓ |
| Fall prevention: remove throw rugs, install handrails, ensure adequate lighting, use assistive devices as needed | - | ✓ | ✓ |
| Energy conservation and pacing strategies for CMT-related fatigue; plan activities with rest periods | - | ✓ | ✓ |
| Avoid prolonged pressure on nerves (especially HNPP): do not cross legs, use padded armrests, reposition frequently during sleep and prolonged procedures | ✓ | ✓ | ✓ |
| Annual comprehensive foot and orthotic reassessment; early intervention prevents progressive deformity | - | - | ✓ |
| Smoking cessation (microvascular disease worsens neuropathy) | - | ✓ | ✓ |
| Alcohol moderation (alcohol is directly neurotoxic and worsens peripheral neuropathy) | - | ✓ | ✓ |
...
|-----------|:--:|:----:|:---:|:---:|-----------|------------------|-------------------|
| CMT Neuropathy Score (CMTNS/CMTNSv2) | - | - | ROUTINE | - | Every 6-12 months | Stable or minimal change (1-2 points/year typical for CMT1A) | Document progression rate; adjust supportive care; consider clinical trial enrollment |
| Manual muscle testing (MRC grading) | - | ROUTINE | ROUTINE | ROUTINE | Every 6-12 months; each admission | Stable strength | Adjust PT/OT program; orthotic reassessment; functional adaptation |
| Spirometry (FVC upright and supine) | STAT | ROUTINE | ROUTINE | STAT | Annually if FVC <80% or respiratory symptoms; baseline then as indicated | FVC >80% predicted; <10% supine drop | Refer pulmonology; consider NIV/BiPAP if FVC <50% or symptomatic; sleep study if nocturnal hypoventilation |
| Foot examination | - | ROUTINE | ROUTINE | - | Every 6-12 months | No new ulceration; stable deformity | Orthotic adjustment; podiatry referral; surgical consultation for progressive deformity |
| ECG | STAT | ROUTINE | ROUTINE | STAT | Annually if LMNA or cardiac-associated CMT subtype; baseline for all | Normal sinus rhythm; no conduction block | Cardiology referral; consider ICD for conduction disease |
| Echocardiogram | - | ROUTINE | ROUTINE | - | Annually if LMNA or cardiac-associated CMT subtype | Normal LVEF; no structural abnormalities | Cardiology referral; heart failure management |
| Pain assessment (NRS, DN4) | ROUTINE | ROUTINE | ROUTINE | ROUTINE | Every visit | Adequate pain control (NRS <4) | Adjust analgesic regimen; add or switch neuropathic pain agents |
| Fall risk assessment | ROUTINE | ROUTINE | ROUTINE | - | Every visit | No falls or near-falls | PT reassessment; environmental modifications; assistive device upgrade |
| Renal function (CrCl) | STAT | ROUTINE | ROUTINE | STAT | Baseline; with gabapentinoid use; every 6-12 months | CrCl >60 for full gabapentinoid dosing | Adjust gabapentin/pregabalin dose per CrCl |
| LFTs | - | ROUTINE | ROUTINE | - | Baseline if starting duloxetine or tizanidine; then periodically | Normal | Dose adjustment or switch medication if hepatic impairment |
| Genetic counseling follow-up | - | - | ROUTINE | - | At diagnosis; pre-conception; at family request | Informed decision-making | Referral to genetics; update testing with new gene discoveries |
| 10-meter walk test / 6-minute walk test | - | ROUTINE | ROUTINE | - | Every 6-12 months | Stable or minimally declining | Adjust rehabilitation; adaptive equipment; consider clinical trial |
| Depression/anxiety screening (PHQ-9, GAD-7) | - | ROUTINE | ROUTINE | - | Annually or with symptom concern | Not clinically significant | Psychiatry referral; pharmacotherapy; adjust pain management |
| NCS/EMG follow-up | - | - | ROUTINE | - | At diagnosis; PRN for symptom change; q2-3 years for monitoring | Stable conduction parameters | If progressive beyond expected, evaluate for superimposed acquired neuropathy (CIDP) |
| Respiratory function (severe CMT/CMT2C/CMT4) | STAT | STAT | ROUTINE | STAT | Q4h if concern; FVC and NIF | FVC >20 mL/kg; NIF <-30 cmH2O | ICU transfer if FVC <20 mL/kg or NIF >-30 cmH2O; intubation if declining |
...
|---|----------|-------------|------|
| 1 | Pareyson D, Marchesi C. Diagnosis, natural history, and management of Charcot-Marie-Tooth disease. Lancet Neurol. 2009;8(7):654-667. | Comprehensive review of CMT classification, diagnosis, and management | PubMed |
| 2 | Shy ME, et al. CMT1 neuropathies: diagnosis and management. Neurology. 2005;64(12):2220-2226. | AAN practice parameter for CMT1 diagnosis and management; genetic testing algorithm | PubMed |
| 3 | Reilly MM, Murphy SM, Laura M. Charcot-Marie-Tooth disease. J Peripher Nerv Syst. 2011;16(1):1-14. | Updated review of CMT genetics, phenotypes, and emerging therapies | PubMed |
| 4 | Pareyson D, et al. Ascorbic acid in Charcot-Marie-Tooth disease type 1A (CMT-TRIAAL and CMT-TRAUK): a double-blind randomised trial. Lancet Neurol. 2011;10(4):320-328. | High-dose ascorbic acid showed NO benefit in CMT1A; large multicenter RCT | PubMed |
| 5 | Attarian S, et al. An exploratory randomised double-blind and placebo-controlled phase 2 study of a combination of baclofen, naltrexone and sorbitol (PXT3003) in patients with Charcot-Marie-Tooth disease type 1A. Orphanet J Rare Dis. 2014;9:199. | PXT3003 showed dose-dependent improvement in ONLS score in CMT1A; phase 3 trial ongoing | PubMed |
| 6 | Corrado B, et al. Evidence-based practice in rehabilitation of Charcot-Marie-Tooth disease: a systematic review. J Exerc Rehabil. 2019;15(4):467-477. | Moderate exercise is safe and beneficial in CMT; avoid high-intensity eccentric exercise; AFOs improve gait | PubMed |
| 7 | Weimer LH, Podwall D. Medication-induced exacerbation of neuropathy in Charcot-Marie-Tooth disease. J Neurol Sci. 2006;242(1-2):47-54. | Comprehensive review of neurotoxic medications in CMT; vincristine is highest risk; provides risk categorization | PubMed |
| 8 | Murphy SM, et al. Reliability of the CMT neuropathy score (second version) in Charcot-Marie-Tooth disease. J Peripher Nerv Syst. 2011;16(3):191-198. | CMTNSv2 is reliable outcome measure for CMT clinical trials and longitudinal monitoring | PubMed |
| 9 | Padua L, et al. Natural history of Charcot-Marie-Tooth 2: 2-year follow-up of muscle strength, walking ability and quality of life. Neurol Sci. 2010;31(2):175-178. | CMT2 shows slower progression than CMT1 in longitudinal follow-up; CMTNS useful for monitoring | PubMed |
| 10 | Mannil M, et al. Nerve ultrasound in hereditary motor and sensory neuropathies. Eur J Neurol. 2014;21(3):400-407. | Nerve ultrasound shows diffuse enlargement in CMT1A; distinguishes from CIDP (patchy enlargement) | PubMed |
...
|---------|------|---------|
| 1.1 | 2026-02-11 | Checker rebuild: merged 3D/3E into single 3D (max 3A-3D); expanded 3B with symptomatic treatments (cramps, fatigue, mood, spasticity); restructured Section 4 to standard 4A Referrals/4B Patient Instructions/4C Lifestyle with table format; added venue columns (ED/HOSP/OPD/ICU) to Section 6 Monitoring; moved LP to proper position after imaging per style guide; improved setting coverage (ED spirometry, ECG, CXR; ICU echo); added medications: nortriptyline, mexiletine, magnesium, quinine, modafinil, sertraline, venlafaxine, baclofen, tizanidine |
